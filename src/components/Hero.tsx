        ...
        <div className="flex justify-center mt-8">
          <div className="inline-flex relative">
            <h1 className='text-7xl sm:text-9xl font-bold tracking-tightner text-center inline-flex'>
              Project SunFlower <br />
            </h1>
          </div>
        </div>
        <div className="flex justify-center">
          <p className='text-xl text-center mt-8 max-w-md'>
          Experience the future of solar energy with our groundbreaking sun-tracking system! This revolutionary product transforms sunlight into maximum power, effortlessly following the sun path. Say goodbye to energy waste and hello to unmatched efficiency. It's not just a solar panel—
          
          
          it's the smartest energy solution of all time!
          </p>
        </div>
        <div className="flex justify-center mt-8">
