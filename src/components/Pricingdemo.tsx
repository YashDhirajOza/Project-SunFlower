...
<div className='max-w-xl mx-auto'>
  <p className="text-center mt-5 text-xl text-white/70">
    Find the perfect solar tracking solution for your energy needs. Whether it's for residential, commercial, or industrial use, we have a plan designed to maximize your solar output and savings.
  </p>
</div>
